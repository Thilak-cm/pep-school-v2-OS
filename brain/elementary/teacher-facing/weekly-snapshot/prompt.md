...
COVERAGE GAPS
- The curriculum domains for this program are: Language Arts, Mathematics, Sciences & Cultural Studies, Creative Arts.
...
- Ensure coverageGaps is an array (possibly empty), never null. Only include domains from the list: Language Arts, Mathematics, Sciences & Cultural Studies, Creative Arts.
