...
COVERAGE GAPS
- The curriculum domains for this program are: Practical Life, Social-Emotional, Language & Literacy, Mathematics & Sensorial.
...
- Ensure coverageGaps is an array (possibly empty), never null. Only include domains from the list: Practical Life, Social-Emotional, Language & Literacy, Mathematics & Sensorial.
