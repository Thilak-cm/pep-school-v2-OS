...
**Steps:**
1. Read `.codex/skills/codebase-context-scan/references/pep-os-overview.md`
...
3. Load matching deep-dive reports from `.codex/skills/codebase-context-deep-dive/references/deep-dives/{area_tag}.md`
