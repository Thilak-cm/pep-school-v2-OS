...
- Overview file: `.codex/skills/codebase-context-scan/references/pep-os-overview.md`
...
3. Generate reports:
   - Single area: `node .codex/skills/codebase-context-deep-dive/scripts/generate-deep-dive.mjs --area <area_tag>`
...
- Output directory: `.codex/skills/codebase-context-deep-dive/references/deep-dives/`
