...
describe('getDefaultReportDateRange', () => {
  ...
  it('returns June 1 of current year when current month is November', () => {
    // November 20, 2025
  ...
  it('returns June 1 of current year when current month is December', () => {
    // December 5, 2025
  ...
  it('returns June 1 of previous year on May 31 (boundary)', () => {
    // May 31, 2026 — just before the academic year starts
  ...
  it('returns June 1 of current year on exactly June 1 (boundary)', () => {
    // June 1, 2026 — academic year start day
