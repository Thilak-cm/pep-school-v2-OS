...
import { Description, GraphicEq, Psychology, AutoAwesome } from '@mui/icons-material';
import { isSuperAdmin } from '../utils/roleUtils';

export default function AIHomePage({ userRole, onOpenTextEditor, onOpenVoiceEditor, onOpenCoachEditor, onOpenBaseballCardConfig }) {
