...
const StudentStatsDialog = ({ open, onClose, student }) => {
  ...
  const getStudentName = () => {
    ...
    return student.displayName || student.name || `${student.firstName || ''} ${student.lastName || ''}`.trim() || 'Student';
  };
...
export default StudentStatsDialog;
