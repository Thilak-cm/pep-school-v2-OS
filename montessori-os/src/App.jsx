            ...
            {!loading && user && (
              <>
                ...
                <Box ref={scrollRef} sx={{
                  ...
                  <Box sx={{ padding: { xs: 2, sm: 3 }, display: 'flex', flexDirection: 'column', minHeight: 0, pt: showHeader ? `${HEADER_HEIGHT}px` : 0, pb: showFooter ? { xs: 12, sm: 12 } : 0, width: '100%', maxWidth: '100%', overflowX: 'hidden', boxSizing: 'border-box' }}>
