...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: '"Coming Soon", cursive', fontWeight: 400, fontSize: '2rem', lineHeight: 1.2 },
    h2: { fontFamily: '"Coming Soon", cursive', fontWeight: 400, fontSize: '1.875rem', lineHeight: 1.2 },
    h3: { fontFamily: '"Coming Soon", cursive', fontWeight: 400, fontSize: '1.5rem', lineHeight: 1.2 },
