// Fallback system prompt for baseball card summaries.
// Previously re-exported from functions/config/baseballCardPrompt.js; inlined here after
// that file was removed (PEP-132: per-program config replaces the single-doc fallback).
