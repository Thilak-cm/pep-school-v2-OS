 ...
 *
 * Usage:
 *   node scripts/admin/test-soul-generation.mjs <studentId>
 *   node scripts/admin/test-soul-generation.mjs 2025-ADO-001
 *   node scripts/admin/test-soul-generation.mjs 2025-ADO-001 --window=90
 *   node scripts/admin/test-soul-generation.mjs 2025-ADO-001 --write
 *
...
if (!studentId) {
  console.error("Usage: node scripts/admin/test-soul-generation.mjs <studentId> [--window=365] [--write]");
  process.exit(1);
}
...
async function run() {
  ...
  if (writeFlag) {
    ...
    console.log("Add --write to persist: node scripts/admin/test-soul-generation.mjs " + studentId + " --write");
  }
}
